...
export default class AgregarPromo extends Component {
  ...
  constructor(props) {
    super(props);
     this.state = {
      ...
      label: 'Las promociones que se encuentren inactivas sera activadas de forma automatica a su fecha de inicio.',
...
crear(){
    ...
    return fetch('http://www.mako.guru/listadosApp/CrearPromo.php',{
    method:'POST',
    headers:{
...
.catch((error) => {
 ...
 <View style={styles.container}>
  ...
  <ScrollView style={styles.formulario}>
        <Text style={[styles.txtId,{color: this.state.colorCiudad}]}>{'Creando promoción'}</Text>
        ...
        <TextInput placeholder={'Procentaje de descuento'} placeholderTextColor="gray"  onChangeText={porciento => this.setState({porciento})} style={styles.txtFormu}>{this.state.porciento}</TextInput>
        ...
        <Text style={styles.txtId}>Hasta agotar existencias</Text>
         ...
         <View>
        <Text style={styles.txtId}>Activar</Text>
          ...
          buttonColor={this.state.colorCiudad}
          formHorizontal={true}
          onPress={(value) => {this.setState({activo:value})}}/>
          </View>
