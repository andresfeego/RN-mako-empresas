...
export default class AgregarInfo extends Component {
...
crear(){
    ...
    return fetch('http://www.mako.guru/listadosApp/CrearInforma.php',{
    method:'POST',
    headers:{
...
.catch((error) => {
 ...
 <View style={styles.container}>
  ...
  <ScrollView style={styles.formulario}>
        <Text style={[styles.txtId,{color: this.state.colorCiudad}]}>{'Creando Informativo'}</Text>
